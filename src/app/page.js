...
export default function Home() {
  ...
  return (
    <section className="relative flex flex-col h-screen w-full max-w-md mx-auto border border-slate-500 p-5 rounded-2xl gap-4">
      ...
      <div className="absolute flex w-full bottom-0 left-0 items-center p-2 justify-center">
